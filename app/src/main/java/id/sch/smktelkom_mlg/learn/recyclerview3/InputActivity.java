...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivFooto = (ImageView) findViewById(R.id.imageViewFoto);
        ...
        ivFooto.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private boolean isValid(String judul, String deskripsi, String detail, String lokasi, Uri uriFoto) {
        ...
        if (uriFoto == null) {
            Snackbar.make(ivFooto, "Foto Belum Ada", Snackbar.LENGTH_SHORT).show();
            valid = false;
        }
        return valid;
    }
